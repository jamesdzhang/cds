...
/**
 * ==============================================================================
 * <b></>Copy this from spring-web is because the old tsp jar need this piece.
 * Therefore others in spring-web have plenty conflicts with spring boot.</b>
 * ==============================================================================
...
public class MappingJacksonHttpMessageConverter extends AbstractHttpMessageConverter<Object>
	 ...
	 * <p>The default implementation returns {@link TypeFactory#type(Type)}
	...
	protected JsonEncoding getJsonEncoding(MediaType contentType) {
		if (contentType != null && "UTF-8" != null) {
